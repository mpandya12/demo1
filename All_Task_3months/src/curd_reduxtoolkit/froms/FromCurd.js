    ...
    jsx: (
      <>
        ...
        <div>
          ...
          <span style={{ marginLeft: "5px", fontSize: "25px" }}>Refrence</span>
        </div>
          ...
          <div>
            ...
            <span style={{ marginLeft: "5px", fontSize: "25px" }}>Back</span>
          </div>
          <div>
            <AiOutlineEdit
              style={{ width: "50px", height: "40px" }}
            ...
            />
            <span style={{ marginLeft: "5px", fontSize: "25px" }}>Edit</span>
          </div>
          <div>
          <div onClick={(emp) => handleDelete(emp)}>
            <AiOutlineDelete style={{ width: "50px", height: "40px" }} />
            <span style={{ marginLeft: "5px", fontSize: "25px" }}>Delete</span>
          </div>
          </div>
    ...
    <>
      ...
      <div style={{ marginLeft: "100px" }}>
        <table className="table ">
          ...
          <tbody
            style={{ overflowY: "auto", height: "490px" }}
            onContextMenu={useCM(menuConfig)}
          >
