...
function Curd() {
  ...
  const fetchdata = (page) => {
    ...
    setTimeout(() => {
      ...
      setrows((prevRows) => (page === 1 ? [...newData] : [...prevRows, ...newData]));
 ...
 // useEffect(() => {}, [setSelectedRows]);
  ...
  return (
    <>
      ...
      <div onScroll={onScroll}id="scroll-container" style={{ overflowY: "auto", height: "400px" }}>
...
const YourComponent = () => {
  ...
  return (
    <>
      <tbody
        ref={tbodyRef}  {/* Attach the ref to the tbody element */}
        onScroll={onScroll}
      ...
      <BsArrowUpCircleFill
        onClick={scrollToTop}  {/* Call scrollToTop function on icon click */}
      />
    </>
  );
};
